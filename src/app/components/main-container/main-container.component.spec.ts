...
describe('MainContainerComponent', () => {
  ...
  it('getForm() should set the form received as flightInfos value', () => {
    component.getForm(flightFormDummy["value"]);
    fixture.detectChanges();
    expect(component.flightInfos).toBeDefined();
    expect(component.flightInfos).toEqual(flightFormDummy["value"]);
